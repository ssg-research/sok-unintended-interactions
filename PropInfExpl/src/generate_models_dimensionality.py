...
def main(args: argparse.Namespace, log: logging.Logger) -> None:
    ...
    if args.dataset == "CENSUS":
        ...
        X_train = SelectKBest(f_classif, k=args.num_features).fit_transform(X_train, y_train)
        X_test = SelectKBest(f_classif, k=args.num_features).fit_transform(X_test, y_test)
        ...
        for i in range(args.num):
            ...
            save_path = result_path / args.split / args.filter / str(args.num_features) / str(args.ratio)
